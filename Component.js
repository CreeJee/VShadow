    ...
    const BaseComponent = (anyHtmlClass) => {
        const classObj = class BaseComponent extends anyHtmlClass{
            ...
            connectedCallback(){
                ...
                (async ()=>{
                    const _getParent = (_parent)=>_parnet.$store instanceof Store ? _parent : _parent === ROOT_HTML ? ROOT_HTML : _getParent((_parent instanceof DocumentFragment ? _parent.root : _parent).parentNode) ;
